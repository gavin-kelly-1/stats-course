...
function start_poll() {
    var question = $(current_poll).children("h3").text();
...
function stop_poll() { 
    ...
    $.get( url+"/api/?method=stop_poll", function( res ) { 
        ...
        $(current_poll).find("ul > li[data-poll='correct'] > .poll-answer-text").each(function(i) { $(this).html("&rightarrow; "+$(this).html()+" &leftarrow;").css("background-color","#e30613")});
        current_poll = null;
    });
}
